...
public class ServerArgumentParser {
    ...
    private void parseValues() {
        ...
        if(this.cmd.hasOption(ServerParameters.MAPS_DIR.toString())) {
            ...
            this.argValues.put(ServerParameters.MAPS_DIR.toString(), "worker/datasets");
        }
    ...
    private void setupCLIOptions() {
        ...
        final Option mapsDirectoryOption = new Option(ServerParameters.MAPS_DIR.toString(),
                true, "directory with maps on the server (default: WORKING_DIR/worker.datasets).");
    ...
    public ServerArgumentParser(final String[] args) {
        ...
        System.out.println("> [Worker.ServerArgumentParser]: setupCLIOptions() DONE.");

        // Set values
        try {
            this.cmd = this.parser.parse(this.options, args);
        } catch (ParseException e) {
            System.out.println("> [Worker.ServerArgumentParser]: ParseException.");
